			...
			<div class="row">
				<div class="col-sm-2">
					<div class="list-group">
						<a href="${pageContext.request.contextPath}/banji/find.action" class="list-group-item active">班级列表</a>
						<a href="${pageContext.request.contextPath}/banji/goadd.action" class="list-group-item">
							添加班级
						</a>
						<a href="${pageContext.request.contextPath}/banji/goelective.action" class="list-group-item">
							班级选课
						</a>
					</div>
				</div>
	        ...
	        -->
				<div class="col-sm-10">
					...
					<table class="table">
						...
						<c:forEach items="${pageBean.objList }" var="banji">
							<tr>
							<td>${banji.banji_id }</td>
							<td>${banji.banji_name }</td>
							<td>${banji.banji_courses_name }</td>
							<td>${banji.banji_totalCredits }</td>
						</tr>
						</c:forEach>
					</table>
					<!-- 展示列表,结束 -->
					...
					<!-- 分页结束 -->
					<!--隐藏的用于分页的表单 -->
					<form id="pageIndexForm" action="${pageContext.request.contextPath}/banji/find.action" method="post">
