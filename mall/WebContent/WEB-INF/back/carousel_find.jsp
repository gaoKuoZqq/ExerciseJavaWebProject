		        ...
		        <span class="icon-bar"></span>
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav">
							<li class="active">
								<a href="${ctx}/carousel/find.action"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;分类管理 <span class="sr-only">(current)</span></a>
							</li>
							<li>
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-2">
					...
					<a href="${ctx}/carousel/find.action" class="list-group-item active" style="color: green">查询全部</a>
					<a href="${ctx}/carousel/goadd.action" class="list-group-item" style="color: green">添加图片</a>
					</div>
				</div>
				<!--
	        	描述：左侧竖向列表结束
				...
				<div class="col-sm-10">
					...
					<ul class="nav nav-tabs">
						<li role="presentation" class="active">
							<a href="${ctx}/student/find.action">图片列表</a>
						</li>
						<li role="presentation">
							<a href="${ctx}/carousel/goadd.action">添加图片</a>
						</li>
					</ul>
					<!--
                    	描述：功能区上部小导航,结束
