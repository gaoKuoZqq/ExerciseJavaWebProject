			...
			<div class="row">
				<div class="col-sm-2">
					<div class="list-group">
						<a href="#" class="list-group-item active">班级列表</a>
						<a href="${pageContext.request.contextPath}/gojsp?method=goBanjiAdd" class="list-group-item">
							添加班级
						</a>
						<a href="${pageContext.request.contextPath}/banji?method=electiveCourses" class="list-group-item">
							班级选课
						</a>
					</div>
				</div>
				...
				<div class="col-sm-10">
					...
					<ul class="nav nav-tabs">
						...
						<li role="presentation">
							<a href="${pageContext.request.contextPath}/gojsp?method=goBanjiAdd">添加班级</a>
						</li>
					</ul>
					<!--
                    	描述：功能区上部小导航,结束
					...
					<table class="table">
						...
						<c:forEach items="${pageBean.list }" var="banjiCourseString">
							<tr>
							<td>${banjiCourseString.banjiId }</td>
							<td>${banjiCourseString.banjiName }</td>
							<td>${banjiCourseString.courses }</td>
							<td>${banjiCourseString.banjiCredit }</td>
						</tr>
						</c:forEach>
					</table>
					<!-- 展示列表,结束 -->
					...
					<!-- 分页结束 -->
					<!--隐藏的用于分页的表单 -->
					<form id="pageIndexForm" action="${pageContext.request.contextPath}/banji?method=queryBanjis" method="post">
