...
<title>Insert title here</title>
	...
	$(function() {
	       $("#addStudent").click(function(){
	           ...
	           var studentBirthday = $("#studentBirthday").val();
	           $.post(
	               "${pageContext.request.contextPath}/student?method=addStudent", //url
	               {"studentName":studentName,
	            	 "studentAge":studentAge,
	            	 "studentGender":studentGender,
	            	 "studentBanji_id":studentBanji_id,
			...
			<div class="row">
				<div class="col-sm-2">
					<div class="list-group">
						<a href="${pageContext.request.contextPath}/student?method=queryStudents" class="list-group-item">学生列表</a>
				...
				<div class="col-sm-10">
					...
					<ul class="nav nav-tabs">
						<li role="presentation">
							<a href="${pageContext.request.contextPath}/student?method=queryStudents">学生列表</a>
						</li>
					...
					<!--
                    	描述：功能区上部小导航,结束
                    -->
					<form action="student?method=addStudent" class="form_border" method="post">
						<div class="form-group" style="margin-top:10px;">
							<label for="exampleInputEmail1">学生姓名</label><span id="exit" style="color:red"></span>
							<input id="studentName" class="form-control" id="exampleInputEmail1" placeholder="输入学生姓名,例: 大黄">
						</div>
