...
<title>Insert title here</title>
	...
	$(function() {
	       $("#addBanji").click(function(){
	           ...
	           $.post(
	               "${pageContext.request.contextPath}/banji?method=addBanji", //url
	               {"coursesId":coursesId,
	            	"banjiName":banjiName,
	               }, //data
			...
			<div class="row">
				<div class="col-sm-2">
					<div class="list-group">
						<a href="${pageContext.request.contextPath}/banji?method=queryBanjis" class="list-group-item">班级列表</a>
				...
				<div class="col-sm-10">
					...
					<ul class="nav nav-tabs">
						<li role="presentation">
							<a href="${pageContext.request.contextPath}/banji?method=queryBanjis">班级列表</a>
						</li>
